...
export default function ChinaPage() {
  ...
  useEffect(() => {
    ...
    if (window.fbq) {
      // @ts-ignore
      window.fbq('init', '2448331412211737');
      // @ts-ignore
      ...
      <div className="flex flex-col min-h-dvh bg-black text-white selection:bg-primary/20">
        <main className="flex-grow flex flex-col items-center p-4 sm:p-6 font-body">
          <div className="w-full max-w-md mx-auto flex flex-col items-center text-center space-y-6">
            ...
            <div className="w-full max-w-[328px] px-4 transform transition-transform hover:scale-105 duration-300" style={{ marginTop: '1px' }}>
              <Image
            ...
            <div className="w-full space-y-1 text-center px-4" style={{ marginTop: '-3px' }}>
            ...
            <div className="flex flex-col items-center space-y-4 pt-4 w-full px-4" style={{ marginTop: '-15px' }}>
              <div className="text-center space-y-2">
