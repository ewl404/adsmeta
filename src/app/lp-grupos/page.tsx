        ...
        <div className="w-full max-w-md mx-auto flex flex-col items-center text-center space-y-6">
          ...
          <div className="flex flex-col items-center space-y-4 pt-4 w-full px-4">
            ...
            <Button
              ...
              size="lg"
              className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-extrabold text-xl py-8 px-10 rounded-lg shadow-[0_8px_25px_rgba(34,197,94,0.5)] transition-all duration-300 ease-in-out hover:shadow-[0_10px_40px_rgba(34,197,94,0.6)] animate-pulse-gentle"
            >
